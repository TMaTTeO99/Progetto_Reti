...
public class StartServerWordleMain {
    ...
    private static final String ConfigureFileName = "config.txt"; //nome del file contenente le info di configurazione
     ...
     * */
    private static final String PathStart = "../"; //Path della dir da cui cominciare la ricerca nel file
    ...
    public static void SearchFile(File curfile) {
        ...
        for(int i = 0; i<lst.length; i++) {
            File next = new File(curfile+"/"+lst[i]);
            try {
                if(next.isFile()) {
    ...
    public static void main(String [] args) {
        ...
        try {
            ...
            ServerWordle server = new ServerWordle(MaxThread, TimeStempWord);
            Thread.sleep(10000);//dormo per 30 secondi e poi chiudo
