...
public class ImplementazioneRegistrazione extends RemoteServer implements Registrazione {
    ...
    public ImplementazioneRegistrazione(ConcurrentHashMap<String, Utente> R, LinkedBlockingDeque<DataToSerialize<?>> Lst,
    ...
    private int ChckInput(String username, String passwd) {
        ...
        for(int i = 0; i < pass.length; i++) {//controllo che nella password sia presente un numero e una lettera maiuscola
            ...
            if(pass[i] == ' ' || pass[i] == '\t')return -5;//controllo che non ci siano spazi o tab
        }
